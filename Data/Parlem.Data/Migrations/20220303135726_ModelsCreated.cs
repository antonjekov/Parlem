    ...
    public partial class ModelsCreated : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GivenName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FamilyName1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductsSelled", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductsSelled_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductsSelled_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductsSelled_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductsSelled_ClientId",
                table: "ProductsSelled",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductsSelled_CustomerId",
                table: "ProductsSelled",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductsSelled_IsDeleted",
                table: "ProductsSelled",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_ProductsSelled_ProductId",
                table: "ProductsSelled",
                column: "ProductId");
        }
